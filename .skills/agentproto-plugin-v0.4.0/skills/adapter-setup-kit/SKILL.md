...
description: >-
  ...
  distant », ou parler de `adapter_list` / `setup_tunnel_provider` /
  `tunnel_create`. Complète les skills d'orchestration (qui SUPPOSENT l'adapter
...
est installé — un `agent_start` sur un adapter `supported` (pas installé)
échoue.
