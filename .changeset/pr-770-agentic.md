...
Weekly dependency bump: minor/patch updates for @anthropic-ai/claude-agent-sdk, Mastra packages, React framework, tooling dependencies (turbo, esbuild), and utilities (ws, yaml).
