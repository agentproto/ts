...
Weekly minor/patch dependency bump across the workspace:

- @anthropic-ai/claude-agent-sdk 0.3.200 → 0.3.220
- @changesets/cli 2.31.0 → 2.31.1
- @clack/prompts 1.6.0 → 1.7.0
- @earendil-works/pi-tui 0.80.2 → 0.82.1
- @mastra/core 1.48.0 → 1.52.1
- @mastra/libsql 1.10.1 → 1.17.0
- @mastra/memory 1.19.0 → 1.23.1
- @opentelemetry/api 1.9.0 → 1.9.1
- @xterm/addon-fit 0.10.0 → 0.11.0
- e2b 2.31.0 → 2.36.0
- esbuild 0.25.12 → 0.28.1
- mastracode 0.27.0 → 0.32.1
- react 19.2.7 → 19.2.8
...
All updates are backwards compatible patch/minor versions. Major bumps remain skipped per project policy.
