...
describe("defineIntent (AIP-28)", () => {
  // The AIP-28 doctype uses 'id' + 'description' instead of the cross-AIP
  ...
  it("imports cleanly", () => {
    expect(typeof defineIntent).toBe("function")
  })

  // TODO: spec-28 tests — see @agentproto/operator's test suite as
