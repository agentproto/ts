...
describe("defineCompany (AIP-6)", () => {
  // The AIP-6 doctype uses 'id' instead of the cross-AIP
  ...
  it("imports cleanly", () => {
    expect(typeof defineCompany).toBe("function")
  })

  // TODO: spec-6 tests — see @agentproto/operator's test suite as
