...
> **workflow-engine** (`workflow_run_file` / `RoutineRunner`) — different thing.
> The word "workflow" here = an agentflow lane defined by a `WORKFLOW.md`.
