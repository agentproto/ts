...
- c5b9e2b: Sync generated catalog data from the pinned provider sources.
...
- 5aad102: Sync generated catalog data from the pinned provider sources.
- e3054e1: Sync generated catalog data from the pinned provider sources.
...
- 9c31c86: Sync generated catalog data from the pinned provider sources.
- 4ade388: Sync generated catalog data from the pinned provider sources.
- f89414a: Sync generated catalog data from the pinned provider sources.
- c27f0b8: Weekly minor/patch dependency bumps across workspaces (zod, @mastra/*, react, yaml, claude-agent-sdk, etc.).
- 9c31c86: Sync generated catalog data and provider snapshots from pinned sources (huggingface/openrouter route updates, refreshed snapshots).

## 0.9.4

### Patch Changes

- bb3342f: Sync generated catalog data from the pinned provider sources.
