...
- 276dceb: Add README documenting ConnectorMcpDescriptor kinds and guards
...
- 0cca2cd: Add @agentproto/connector — ConnectorMcpDescriptor discriminated union, type guards, and Zod schema
